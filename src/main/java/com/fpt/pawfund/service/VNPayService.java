...
//
//import com.fpt.pawfund.config.VNPayConfig;
    ...
    public String createOrder(int total, String orderInfor, String urlReturn){
        ...
        for (String fieldName : fieldNames) {
            ...
            if ((fieldValue != null) && (fieldValue.length() > 0)) {
                ...
                // Build query
                query.append(encodeUTF8(fieldName)).append('=').append(encodeUTF8(fieldValue)).append('&');
            }
        }

        // Remove trailing '&' in hashData and query if present
